...
search for `"climate_analysis"` and replace it with a concise version of your project's
name. Importantly, you also need to rename the folder `src/climate_analysis` to
